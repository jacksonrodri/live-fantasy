                                ...
                                !isSelected ?
                                    ...
                                    <div className={classes.container_selected}>
                                        <p className={classes.container_selected_p_1}>
                                            <Tick2 /> Selected <img src={DeleteIcon} onClick={() => onSelectDeselect(id)} />
                                        </p>
                                    </div>
                            }
                        </div>
                            ...
                            >
                                <div className={classes.card_state}>
                                    <div className={classes.card_state_title}>
                                        {
                                            steps?.[0]?.titles?.map((title, ind) => <span key={ind.toString()}>{title}</span>)
                                        }
                                    </div>
                                    <div className={classes.card_state_values}>
                                        {
                                            steps?.[0]?.step?.map((val, ind) => <span key={ind.toString()}>{val}</span>)
                                        }
                                    </div>
                                </div>
                            </div>
