    ...
    return (
        <>
            ...
            <HeroSection
                ...
                subTitle={<>Start your new fantasy experience on our live-play platform <br /> where you have the Power to control your team's destiny!</>}
            />
            <main className={styles.root}>
                ...
                <section className={formStyles.root2}>
                    ...
                    <div className={styles.buttonWrappers}>
                        <button className={styles.verifyIdentityButton}>Verify Your Identity</button>
                        <button className={styles.verifyLaterButton}>I will verify my identity later and forgo the bonus Power Token offer</button>
                    </div>
                    <p className={styles.privacyBlog}>By continuing, you agree to Persona’s <Link to='/privacy'>privacy policy</Link></p>
                </section>
            </main>
            <Footer isBlack={true} />
        </>
